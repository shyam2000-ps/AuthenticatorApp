...
public class MainActivitybot1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestQueue = Volley.newRequestQueue(MainActivitybot1.this);
        ...
        sendMsgIB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userMsgEdt.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(MainActivitybot1.this, "Please enter your message..", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MainActivitybot1.this, RecyclerView.VERTICAL, false);
    ...
    private void sendMessage(String userMsg) {
        ...
        String url = "http://api.brainshop.ai/get?bid=169529&key=UI0gTkWiss6iuUAi&uid=[uid]&msg=" + userMsg;
        //creating a variable for our request queue.
        RequestQueue queue = Volley.newRequestQueue(MainActivitybot1.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MainActivitybot1.this, "No response from the bot..", Toast.LENGTH_SHORT).show();
            }
        });
